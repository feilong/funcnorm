function Q = blurDatasetNoSVD(V, s, varargin)
% FUNCTION Q = blurDatasetNoSVD(V, s, U, cartCoords, nbrs, totalNbrs, resolution)
% ** OR **
% FUNCTION Q = blurDatasetNoSVD(V, s, cartCoords, nbrs, totalNbrs, resolution)
